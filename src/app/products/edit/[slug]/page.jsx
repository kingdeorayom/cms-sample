        ...
        <>
          <div className="p-5 my-5 flex flex-col space-y-4">
            ...
            <h1 className="text-2xl font-bold">
              Edit details of 65-INCH SMART QUANTUM 4K UHD TV
            </h1>
          </div>
          <div className="@container/main flex flex-1 flex-col gap-2 p-5">
            <div className="flex items-center space-x-4">
              <div className="grid w-full max-w-sm items-center gap-3">
                ...
                <Input
                  defaultValue="65-INCH SMART QUANTUM 4K UHD TV
"
                />
              </div>
              <div className="grid w-full max-w-sm items-center gap-3">
            ...
            <div>
              <div className="grid w-full items-center gap-3">
                ...
                <Textarea defaultValue="Sample description" />
              </div>
            </div>
            <div>
              <div className="grid w-full max-w-sm items-center gap-3">
